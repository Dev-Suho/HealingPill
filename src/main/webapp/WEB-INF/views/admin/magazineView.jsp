                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="sform2">
                                ...
                                <a  class="btn btn-gradient-primary mr-2" href="/admin/magazine/delete?mg_no=${magazine.mg_no}" onclick="return confirm('삭제하시겠습니까?');">삭제</a>
                                <script>
                                    var formObj = $("form[role='form']");

                                    $("#modify_btn").click(function (){
                                        formObj.attr("action", "/admin/magazineModify");
