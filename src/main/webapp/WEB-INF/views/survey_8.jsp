                    ...
                    <div class="survey-form survey-intro survey-enable" id="3">
                        ...
                        <div class="container" style="min-height: calc(452px);">
                            <div class="service_guide_area">
                                <!--개인정보 section-->
                                <h2 id="" maxallowed="1">
                                    <p style="font-size: 20px"> <strong> @@님의 몸무게를 적어주세요. </strong> </p><br><br>
                        ...
                        <div class="bot_btn_area type01" style="text-align: center">
                            <button type="button" onclick="location.href='survey_9'">다음</button><br><br>
                            <button type="button" onclick="location.href='survey_7'">이전으로</button>
                        </div>
                    </div>
                </div>
            </div>
