...
import com.healingpill.dao.MagazineDAO;
...
public class MagazineDTO {
    ...
    public String toString() {
        return "MagazineDTO{" +
                ...
                ", mg_datetime'" + mg_datetime + '\'' +
                '}';
    }
    public MagazineDTO(int mg_no,String mg_image,String mg_title,String mg_content,String mg_datetime)
    {
        this.mg_no = mg_no;
        this.mg_image = mg_image;
        this.mg_title = mg_title;
